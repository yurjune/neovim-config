...
return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>e1", set_tree_width(35), { desc = "NvimTree width 35" })
    vim.keymap.set("n", "<leader>e2", set_tree_width(42), { desc = "NvimTree width 42" })
    vim.keymap.set("n", "<leader>e3", set_tree_width(50), { desc = "NvimTree width 50" })
  end,
}
